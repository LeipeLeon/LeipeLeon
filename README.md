...
- [zombocom/maildown](https://github.com/zombocom/maildown) - Write your ActionMailer email templates in Markdown, send in html and plain text (4 weeks ago)
- [hotwired/spark](https://github.com/hotwired/spark) - Hot reloading for Hotwire (4 weeks ago)
- [Drieam/rspec-github](https://github.com/Drieam/rspec-github) - Formatter for RSpec to show errors in GitHub action annotations (4 weeks ago)
