...
- [bonfire-networks/bonfire-app](https://github.com/bonfire-networks/bonfire-app) - Bonfire - tend to your digital life in community. Customise and host your own online space and control your experience at the most granular level. (2 days ago)
- [pmansour/minimeet](https://github.com/pmansour/minimeet) (4 days ago)
- [pmansour/pimeet](https://github.com/pmansour/pimeet) - Bootstrap a Raspberry Pi 4 to run as a portable conference room. (4 days ago)
- [square/ruby-rrule](https://github.com/square/ruby-rrule) - RRULE expansion for Ruby (4 days ago)
- [nateberkopec/ghwatch](https://github.com/nateberkopec/ghwatch) - Github workflow/action/run watcher (5 days ago)
- [tenderlove/zeroconf](https://github.com/tenderlove/zeroconf) - Multicast DNS client and server written in pure Ruby (1 week ago)
